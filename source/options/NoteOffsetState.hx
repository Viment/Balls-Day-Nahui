...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeBarBG = new FlxSprite(0, timeTxt.y + 16).loadGraphic(Paths.image('timeBar'));
		...
		timeBar = new FlxBar(0, timeBarBG.y + 8, LEFT_TO_RIGHT, Std.int(timeBarBG.width - 8), Std.int(timeBarBG.height - 4), this, 'barPercent', delayMin, delayMax);
		timeBar.scrollFactor.set();
		timeBar.screenCenter(X);
		timeBar.createFilledBar(168600, 0xFFFFFFFF);
