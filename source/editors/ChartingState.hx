...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['nukebeast start', "MrBeast's last video - part 1"],
		['Nukebeast Start song', "bruh, stealed from impoptor mod, lel"],
		['nukebeast end', "MrBeast's last video - part 2"],
		['I Bought A Real Nuke $40000 - MrBeast Video', "MrBeast's last video"],
