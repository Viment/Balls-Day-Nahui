...
class EditorPlayState extends MusicBeatState
{
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		var rating:FlxSprite = new FlxSprite(-420, -389);
		//var score:Int = 350;
		...
		{
			var numScore:FlxSprite = new FlxSprite(786, -255).loadGraphic(Paths.image(pixelShitPart1 + 'num' + Std.int(i) + pixelShitPart2));
